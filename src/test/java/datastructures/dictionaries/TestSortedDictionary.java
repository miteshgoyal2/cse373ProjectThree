...
public abstract class TestSortedDictionary extends BaseTest {
    protected abstract <K extends Comparable<K>, V> IDictionary<K, V> newDictionary();
    ...
    @Test(timeout = SECOND)
    public void testNullKeyErrorHandling() {
        IDictionary<String, String> dict = this.newDictionary();
        dict.put("hello", "3");
        dict.put("", "what");
        try {
